  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4">
      {/* <Card className="w-full max-w-md shadow-2xl border-2">
        <CardHeader>
          <div className="">
            <CardTitle className="text-center text-3xl font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
              Bienvenido
            </CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            {error && (
              <div className="p-4 text-sm text-destructive bg-destructive/10 border border-destructive/20 rounded-lg animate-shake">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="usuario@confirmamed.com"
                  value={email}
        ...
        <CardFooter className="flex-col gap-4">
          <div className="w-full">
            <p className="text-xs text-center text-muted-foreground">
              <strong>Cuenta de prueba:</strong> administrador@test.com • 123456
            </p>
          </div>
        </CardFooter>
      </Card> */}

      <Card className="h-full md:h-fit w-full overflow-y-auto remove-scroll max-w-3xl px-4 py-8 flex flex-col md:flex-row justify-between items-center relative">
        {/* Botón de modo (tema) */}
